...
const ThemeIconReact = () => {
  const [themeToggle, setThemeToggle] = useState("light");

  useEffect(() => {
    console.log("1");
    if (localStorage.length === 0) localStorage.setItem("theme", themeToggle);
    else {
      console.log("aqui");
      setThemeToggle(localStorage.getItem("theme"));
    }
  }, []);
